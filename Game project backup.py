...
for i in range(1, 6):
    ...
    Playerattack = random.randint(10, 40) and 1
    Enemyattack = random.randint(10, 40) and 3
    Playerheal = random.randint(10, 30) and 2
    Enemyheal = random.randint(10, 30) and 4
