#need to finish Minecraft and Minecraft foxes theme...
import time
...
while True:
    ...
    if User_chose_theme.lower() == "foxes" or User_chose_theme.lower() == "fox":
        ...
        if q2.lower() == "a":
            ...
            time.sleep(1)
            print("But since it wasn't in the choices, I won't count that!")
        print("That's it for today! Here are your results from all total games: \n--------------------\nYou got " + str(player_correct_answers) + " correct!\nYou got " + str(player_incorrect_answers) + " incorrect!\n----------------------\nLet's play again!")
        time.sleep(1)
    ...
    elif User_chose_theme.lower() == "results" or User_chose_theme.lower() == "result":
        print("Here are your results from all total games: \n--------------------\nYou got " + str(player_correct_answers) + " correct!\nYou got " + str(player_incorrect_answers) + " incorrect!\n----------------------\nLet's play again!")
    else:
        print("Sorry, something went wrong")